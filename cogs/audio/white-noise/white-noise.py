...
class WhiteNoiseCog(BaseSoundCog):
    def __init__(self, bot):
        ...
        super().__init__(bot, "white-noise", sounds, sound_labels, "Play differnet types of noises.📡")
    ...
    @app_commands.command(name="noise", description="Play differnet types of white noises")
    async def white_noise_command(self, interaction: discord.Interaction):
